...
/**
 * The original sBTC deposit UI. It is intentionally kept outside `app/` so
 * it remains available as source without becoming part of the deployed site.
 */
export function LegacyDepositPage() {
  const {
    connected,
